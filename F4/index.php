...
<table width="734" border="0" align="center">
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#ECFBFF" class="style20" style="padding-left:30px">Data da perda do vinculo empregatício:</td>

    <td colspan="3" bgcolor="#ECFBFF" class="style20"><input name="dataVinculo" type="text" id="dataVinculo" onkeyup="mascara(this, '##/##/####')" maxlength="10" /> (somente n&uacute;meros)</td>

  </tr>

  <tr>

    <td colspan="2" bgcolor="#ECFBFF" class="style20" style="padding-left:30px;">Opção:</td>

    <td colspan="3" bgcolor="#ECFBFF" class="style20">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="5" bgcolor="#ECFBFF" style="padding-left:30px;">
      <p class="opcao"><span class="style20"></span>Tendo em vista a perda do vínculo empregatício com o SEBRAE, em relação ao plano SEBRAEPREV solicito:</p>
    </td>
