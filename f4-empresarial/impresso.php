...
function base64ToJson(base64String) {
  ...
  getJson.nomeTermo = "Termo de Opção Empresarial";
  getJson.tipoOpcao = 3;
...
</strong> parcelas (no m&aacute;ximo em 12 parcelas)<br />
<br />
...
?>
<?php if($_POST['opc'] == "opc5") { ?> <div id="x3">
<p class="style3" align="justify">  &nbsp;&nbsp; &nbsp;&nbsp;

  [<?php if($_POST['opc'] == "opc5" ) { echo " X "; } ?>] <strong>CANCELAMENTO DE INSCRIÇÃO</strong> - Solicitação: Solicito o cancelamento de minha inscrição no Plano de Beneficios EMPRESARIAL conforme previsto no art. 12 do Regulamento, e a suspensão do desconto das contribuições mensais em meus vencimentos ou a emissão de cobranças.<br />
  <br />
</p>
</div> <?php }?>
